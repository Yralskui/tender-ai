        ...
        <div className="mt-3 p-3 rounded-xl border border-slate-200 bg-slate-50/80 space-y-3 max-w-3xl">
          ...
          <div className="flex items-center justify-between gap-2">
            <p className="text-[10px] text-slate-500 leading-snug">
              {isTagged
                ? "В разделе с метками истёкшие закупки остаются. Без метки просроченные удаляются автоматически."
                : "Истёкшие без метки скрыты. Просроченные с меткой — в разделе «Метки»."}
            </p>
            <button
              type="button"
